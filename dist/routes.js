...
router.get('/unavailable-dates', isAuthenticated_1.isAuthenticated, new CheckUnavailableDatesController_1.CheckUnavailableDatesController().handle);
router.get('/available-time-slots', isAuthenticated_1.isAuthenticated, new CheckAvailableTimeSlotsController_1.CheckAvailableTimeSlotsController().handle);
